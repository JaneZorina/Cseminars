...
Console.Write("Input a first row number: ");
int r1 = Convert.ToInt32(Console.ReadLine());
Console.Write("Input a secont row number: ");
...
int[,]MyArray (int[,]array, int[]indexes)
{
...
int[,]newArray = CreateRandom2dArray();
Show2dArray(newArray);
Show2dArray(MyArray(newArray,MinElement(newArray)));
